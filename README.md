...
| 対象 | 入口 |
|---|---|
| 外部研究者向け計算モデル・実装フロー解説 | [`技術解説書 v3.3（PDF）`](docs/vtsimnx_calculation_model_and_implementation_flow_ja_v3.3.pdf) / [`Word版`](docs/vtsimnx_calculation_model_and_implementation_flow_ja_v3.3.docx) |
