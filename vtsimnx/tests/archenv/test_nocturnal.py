...
def test_nocturnal_gain_by_angles_accepts_horizontal_night_radiation():
    ...
    out_v = vt.nocturnal_gain_by_angles(傾斜角=90.0, rn_horizontal=s_nh, return_details=True)
    out_h = vt.nocturnal_gain_by_angles(傾斜角=0.0, rn_horizontal=s_nh, return_details=True)
    ...
    # 既定は Series を返す
    out_default = vt.nocturnal_gain_by_angles(傾斜角=90.0, rn_horizontal=s_nh)
...
def test_nocturnal_gain_by_angles_accepts_t_h():
    ...
    out = vt.nocturnal_gain_by_angles(傾斜角=90.0, t_out=t, rh_out=h, return_details=True)
