...
def test_nocturnal_gain_by_angles_accepts_horizontal_night_radiation():
    ...
    out_v = vt.nocturnal_gain_by_angles(傾斜角=90.0, 夜間放射量_水平=s_nh, return_details=True)
    out_h = vt.nocturnal_gain_by_angles(傾斜角=0.0, 夜間放射量_水平=s_nh, return_details=True)
    ...
    # 既定は Series を返す
    out_default = vt.nocturnal_gain_by_angles(傾斜角=90.0, 夜間放射量_水平=s_nh)
...
def test_nocturnal_gain_by_angles_accepts_t_h():
    ...
    out = vt.nocturnal_gain_by_angles(傾斜角=90.0, 外気温=t, 外気相対湿度=h, return_details=True)
