...
STABLE: Final[tuple[ApiSymbol, ...]] = (
    ...
    ApiSymbol("get_artifact_file", "stable", "vtsimnx.artifacts", returns="Path | bytes | DataFrame"),
    ApiSymbol("get_artifact_bytes", "stable", "vtsimnx.artifacts", returns="bytes"),
    ApiSymbol("ArtifactClient", "stable", "vtsimnx.artifacts", returns="ArtifactClient"),
    ApiSymbol("decode_f32_series", "stable", "vtsimnx.artifacts", returns="DataFrame"),
