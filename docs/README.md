...
APIの厳密仕様・運用手順は `api/docs/` 側を正本として参照してください。
...
以下は `api/docs/` を正本とします（core側は概要・導線のみ）。

- APIエンドポイント契約: `../api/docs/api_reference.md`
- builder入力JSON仕様: `../api/docs/builder_json.md`
- solver/aircon挙動の詳細: `../api/docs/simulation_overview.md`, `../api/docs/aircon_control_overview.md`
