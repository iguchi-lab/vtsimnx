...
![式 (12-1)](equations/eq-12-1.svg)

[数式ソース](equations/eq-12-1.tex)

暖房の z は[0,1]に制限、冷房は下限0だけを制限する。p は機器容量と dualcompressor に応じた係数表・補間で決める。

![式 (12-2)](equations/eq-12-2.svg)

[数式ソース](equations/eq-12-2.tex)
...
![補助式](equations/eq-12-aux-3.svg)

[数式ソース](equations/eq-12-aux-3.tex)

![式 (12-3)](equations/eq-12-3.svg)

[数式ソース](equations/eq-12-3.tex)
...
![式 (12-4)](equations/eq-12-4.svg)

[数式ソース](equations/eq-12-4.tex)

送風機は、内部風量 v をm³/hに変換して式 (12-5) により求める。

![式 (12-5)](equations/eq-12-5.svg)

[数式ソース](equations/eq-12-5.tex)
...
![式 (12-6)](equations/eq-12-6.svg)

[数式ソース](equations/eq-12-6.tex)
...
![式 (12-7)](equations/eq-12-7.svg)

[数式ソース](equations/eq-12-7.tex)
